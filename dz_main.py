...
def log_operation(operation_name, message):
    log_path = 'D:/Projects/Python_rasrab/DZ_12/project_root/logs/operations.log'
...
def read_raw():
    path = 'D:/Projects/Python_rasrab/DZ_12/project_root/data/raw'
    processed_path = 'D:/Projects/Python_rasrab/DZ_12/project_root/data/processed'
...
def serialize():
    ...
    with open('D:/Projects/Python_rasrab/DZ_12/project_root/output/processed_files_info.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
...
def create_work_report():
    log_file = 'D:/Projects/Python_rasrab/DZ_12/project_root/logs/operations.log'
    report_file = 'D:/Projects/Python_rasrab/DZ_12/work_report.json'
